...
const header = props => (
  ...
  <Container fluid className="header-image pt-4">
    <Row className="justify-content-md-center pt-5">
      ...
      <Col className="my-5 p-3 py-4 pb-5 bg-white rounded-30 shadow-dark zind-1" md="7" lg="6" xl="4">
	    <Pricing/>
	  </Col>
	  
	  <Col className="my-5 p-3 py-4 pb-5 rounded-30 shadow-dark video-container" md="7" lg="6" xl="4">
